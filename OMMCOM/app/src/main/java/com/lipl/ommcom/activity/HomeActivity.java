...
//                startActivity(intent);
                ...
                try {
                    ...
                    if(i != null && Util.isIntentSafe(HomeActivity.this, i)) {
                        startActivity(i);
                    } else if(Util.isIntentSafe(HomeActivity.this, goToMarket)){
                        startActivity(goToMarket);
                    } else {
                        new AlertDialog.Builder(HomeActivity.this, android.R.style.Theme_DeviceDefault_Light_Dialog_NoActionBar)
