...
import com.lipl.ommcom.twitter.ResponseListener;
import com.lipl.ommcom.twitter.Twitt_Sharing;
import com.lipl.ommcom.twitter.Utils;
import com.lipl.ommcom.util.Config;
import com.lipl.ommcom.util.CustomTextView;
import com.lipl.ommcom.util.URLImageParser;
...
public class NewsDetailsActivity extends AppCompatActivity implements FlipAdapter.OnShareClick,
    ...
    private void updateView() {
        ...
        final String posted_by = news.getUser_name() + "\n";
        ...
        tvDemo.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                Pagination pagination = new Pagination(text,
                    ...
                    String postedBy = news.getUser_name();
