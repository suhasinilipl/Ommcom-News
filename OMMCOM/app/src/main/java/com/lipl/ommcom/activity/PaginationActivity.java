...
import com.lipl.ommcom.adapter.TransformerAdapter;
...
public class PaginationActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_pagination);
...
//        file_maps.put("Hannibal",R.drawable.flower1);
//        file_maps.put("Big Bang Theory",R.drawable.flower2);
//        file_maps.put("House of Cards",R.drawable.flower3);
//        file_maps.put("Game of Thrones", R.drawable.flower4);
        ...
        l.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(PaginationActivity.this, ((TextView) view).getText().toString(), Toast.LENGTH_SHORT).show();
            }
        });
